...
let canvas = $("#game"),
    ...
    fonimg = $('<img>', { src: '/images/starship/fon.png' }),
    asterimg = $('<img>', { src: '/images/starship/astero.png' }),
    shipimg = $('<img>', { src: '/images/starship/ship01.png' }),
    fireimg = $('<img>', { src: '/images/starship/fire.png' }),
    explimg = $('<img>', { src: '/images/starship/expl222.png' }),
    shieldimg = $('<img>', { src: '/images/starship/shield.png' }),
